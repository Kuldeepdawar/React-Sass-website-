...
const About = () => {
    const [state] = React.useState({heading: 'Services and Offerings?', text: 'We provide an outgoing high quality of service, we assist with staff on boarding, staff retention strategies and also attracting talent to your organisation who may have not considered a role with your business previously. We provide police-checks through Intercheck, who are the provider of background checks for Deliveroo. It is important you get quality and verified talent!'});
    const [sections] = React.useState([
      ...
      </svg>, heading: 'Digital Marketing', text: 'Reesby professionals in helping businesses thrive online. With competitively-priced, month-to-month plans, we can help make a difference for your business..'},
    ...
    </svg>, heading: 'Web and web development', text: 'Our rare talent pool and expertise can help grow your team to accommodate for future technology advances. Web and Mobile apps are becoming increasingly.'},
  ...
  </svg>, heading: 'PROFFESSIONAL CVs', text: 'A Curriculum Vitae, or CV for short, is a professional document that summarizes your work history, education, and skills, when you apply for the position.'}
    ]);
    return (
        <div className="about">
